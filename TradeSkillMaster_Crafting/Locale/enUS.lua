...
L["Crafting Cost (No Cooldown Transmutes)"] = true
...
L["Choose the base price source for material costs. Market Value uses the weighted average market price. Min Buyout uses the cheapest auction currently listed."] = true
...
L["Exclude Conversions (Prospect/Mill/DE)"] = true
L["Exclude Cooldown Transmutes from Mat Cost"] = true
...
L["If checked, daily-cooldown transmutes (e.g. Transmute: Eternal Air from Eternal Earth) will NOT reduce material prices. Enable this to stop Eternals and similar items from being priced at the transmute cost of a different Eternal."] = true
L["If checked, prospecting/milling/disenchant conversions will NOT be used to calculate material prices. Enable this if gems or pigments are showing incorrect prices based on ore/herb prospecting rates instead of their actual AH value."] = true
...
L["Material Price Base"] = true
L["Market Value (dbmarket)"] = true
L["Min Buyout (dbminbuyout)"] = true
L["Materials"] = true
L["Materials:"] = true
...
L["This is the default method Crafting will use for determining material cost. This is auto-generated from the options above, but you can also type a custom formula here."] = true
