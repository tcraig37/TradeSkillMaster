	...
	local page = {
		{
			...
			children = {
				...
				{
					type = "CheckBox",
					label = L["Display predicted price in tooltip."],
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "predictedPriceTooltip" },
					tooltip = L["If checked, a predicted future price based on trend analysis will be displayed."],
				},
				{
					type = "CheckBox",
					label = L["Display price trend in tooltip."],
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "trendTooltip" },
					tooltip = L["If checked, the daily price trend (rising/falling/stable) will be displayed."],
				},
				{
					type = "CheckBox",
					label = L["Display volatility score in tooltip."],
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "volatilityTooltip" },
					tooltip = L["If checked, the price volatility (Low/Medium/High) will be displayed."],
				},
				{
					type = "CheckBox",
					label = L["Display confidence score in tooltip."],
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "confidenceTooltip" },
					tooltip = L["If checked, a data confidence score based on scan frequency and recency will be displayed."],
				},
				{
					type = "CheckBox",
					label = L["Display weekday price in tooltip."],
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "weekdayTooltip" },
					tooltip = L["If checked, the average historical price for today's day of the week will be displayed, showing weekly cyclical patterns (e.g. raid reset spikes)."],
				},
				{
					type = "CheckBox",
					label = L["Display smart price in tooltip."],
					disabled = not TSM.db.profile.tooltip,
					settingInfo = { TSM.db.profile, "smartPriceTooltip" },
					tooltip = L["If checked, a composite predicted price blending trend, weekday patterns, and data confidence will be displayed. This is the best single-number price estimate."],
				},
			},
		},
	}
