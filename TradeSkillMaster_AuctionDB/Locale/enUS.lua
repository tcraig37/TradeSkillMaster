...
L["AuctionDB - Predicted Price"] = true
L["AuctionDB - Trend (per day)"] = true
L["AuctionDB - Volatility"] = true
L["AuctionDB - Confidence"] = true
L["AuctionDB - Weekday Price"] = true
L["AuctionDB - Smart Price"] = true
...
L["Display predicted price in tooltip."] = true
L["Display price trend in tooltip."] = true
L["Display volatility score in tooltip."] = true
L["Display confidence score in tooltip."] = true
L["Display smart price in tooltip."] = true
L["Display weekday price in tooltip."] = true
...
L["If checked, a predicted future price based on trend analysis will be displayed."] = true
L["If checked, the daily price trend (rising/falling/stable) will be displayed."] = true
L["If checked, the price volatility (Low/Medium/High) will be displayed."] = true
L["If checked, a data confidence score based on scan frequency and recency will be displayed."] = true
L["If checked, a composite predicted price blending trend, weekday patterns, and data confidence will be displayed. This is the best single-number price estimate."] = true
L["If checked, the average historical price for today's day of the week will be displayed, showing weekly cyclical patterns (e.g. raid reset spikes)."] = true
